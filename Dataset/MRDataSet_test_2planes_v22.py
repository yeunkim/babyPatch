...
class ToTensor(object):
    ...
    def __call__(self, sample):
        neigh1, neigh2 =  sample['neighbors1'], sample['neighbors2']
...
class MRDataSet(Dataset):
    ...
    def __init__(self, dataset, transform=None, pad=5, render=True, pkl = False, slices = True, channels=1, axes=(True,False,False),
        ...
        if self.slices:
            ...
            self.axis_locs = [random.sample(range(bounds[i][0], bounds[i][1]), self.numslices[i]) for i in [0, 1, 2]]
