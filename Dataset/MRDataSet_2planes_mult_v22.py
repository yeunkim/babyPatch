...
class ToTensor(object):
    ...
    def __call__(self, sample):
        label, neigh1, neigh2, uncert1, uncert2 = sample['label'], sample['neighbors1'], sample['neighbors2'], \
...
class MRDataSet(Dataset):
    ...
    def __init__(self, file, file2, transform=None, pad=5, render=True, pkl = False, slices = True, channels=1, axes=(True,False,False),
        ...
        with h5py.File(self.file, 'r') as self.dataset:
            ...
            if self.slices:
                ...
                # TODO: try randomizing slice locations
    ...
    def __getitem__(self, idx):
        ...
        with h5py.File(self.file2, 'r') as self.dataset2:
